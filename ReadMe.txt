...
2. There are also several python modules that you need for this program. They include:
pandas
numpy
torch
chess
...
3. You must have Node.js installed on your machine. Ideally 16.14.2 or newer.
...
node app.js    
4. Once your local server is running just open the main_menu.html file and use the application.